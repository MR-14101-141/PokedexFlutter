...
class _PokeDetailState extends State<PokeDetailScreen> {
  Future<void> pullRefresh() async {
    context
        ...
        .add(PokemonDetailRefreshEvent(widget.url));
  }

  loadDetail() {
    context.read<PokemonDetailBloc>().add(PokemonDetailLoadEvent(widget.url));
  }
          ...
          child: Scaffold(
              appBar: AppBar(
                ...
                title: (state is ResponsePokemonDetailState)
                    ? Text(state.detail['name'].toString().toUpperCase())
                    : const Text(''),
              ),
